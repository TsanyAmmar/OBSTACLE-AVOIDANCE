...
def save_to_csv(data):
    with open(csv_file_name, mode='a', newline='') as file:
        ...
        if file.tell() == 0:
            writer.writerow(['gps value x','gps value y', 'motor kanan', 'motor kiri', 'sensor kiri']) 
...
while robot.step(timestep) != -1:
    ...
    data = [gps_x,gps_y, kecepatan_motor_kanan_last, kecepatan_motor_kanan_last, sensorkiri_konversi]
    save_to_csv(data)
    waktuBerjalan = waktu - waktuMulai
    # if waktuBerjalan >= 200:
         # break
